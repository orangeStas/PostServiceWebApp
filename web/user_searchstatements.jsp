...
<div class="container">
  ...
  <a href="prepareDataForSearchStatementCreation.action" class="btn waves-effect waves-light"><i class="material-icons">add</i></a>
        ...
        <div class="collapsible-body item">
          <div class="row">
            ...
            <ul id='dropdown${statement.id}' class='dropdown-content'>
              <li><a href="downloadSearchStatementDoc.action?search_statement_id=${statement.id}&doc_type=xls">XLS</a></li>
              <li><a href="downloadSearchStatementDoc.action?search_statement_id=${statement.id}&doc_type=csv">CSV</a></li>
              <li><a href="downloadSearchStatementDoc.action?search_statement_id=${statement.id}&doc_type=pdf">PDF</a></li>
            </ul>

...
<div class="container">
  ...
  <a href="/prepayment_book_view.jsp" class="btn waves-effect waves-light"><i class="material-icons">add</i></a>
        ...
        <div class="collapsible-body item">
          <div class="row">
            ...
            <ul id='dropdown${book.clientNumber}' class='dropdown-content'>
              <li><a href="downloadPrepaymentBookDoc.action?prepayment_book_number=${book.statementNumber}&doc_type=xls">XLS</a></li>
              <li><a href="downloadPrepaymentBookDoc.action?prepayment_book_number=${book.statementNumber}&doc_type=csv">CSV</a></li>
              <li><a href="downloadPrepaymentBookDoc.action?prepayment_book_number=${book.statementNumber}&doc_type=pdf">PDF</a></li>
            </ul>

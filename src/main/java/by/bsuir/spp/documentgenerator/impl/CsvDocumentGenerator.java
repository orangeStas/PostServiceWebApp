...
public class CsvDocumentGenerator implements DocumentGenerator {
    ...
    @Override
    public void generatePackage(final by.bsuir.spp.bean.document.Package pack, OutputStream outputStream) throws DocumentException, IOException {
    ...
    @Override
    public void generateAdvertisement(final Advertisement advertisement, OutputStream outputStream) throws DocumentException, IOException {
        ICsvListWriter listWriter = null;
        listWriter = new CsvListWriter(new OutputStreamWriter(outputStream), CsvPreference.EXCEL_PREFERENCE);
        ...
        final by.bsuir.spp.bean.document.Package pack = advertisement.getPostPackage();
    ...
    @Override
    public void generatePrepaymentBook(final PrepaymentBookStatement prepaymentBookStatement, OutputStream outputStream) throws DocumentException, IOException {
    ...
    @Override
    public void generateReceipt(final Receipt receipt, OutputStream outputStream) throws DocumentException, IOException {
        ICsvListWriter listWriter = null;
        listWriter = new CsvListWriter(new OutputStreamWriter(outputStream), CsvPreference.EXCEL_PREFERENCE);
    ...
    @Override
    public void generateSearchStatement(final SearchPackageStatement searchPackageStatement, OutputStream outputStream) throws DocumentException, IOException {
        ICsvListWriter listWriter = null;
        listWriter = new CsvListWriter(new OutputStreamWriter(outputStream), CsvPreference.EXCEL_PREFERENCE);
        ...
        final by.bsuir.spp.bean.document.Package pack = searchPackageStatement.getPostPackage();
        final List<Object> advertisementData = new ArrayList<Object>() {{
